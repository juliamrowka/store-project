        ...
        <div class="d-flex flex-wrap my-4 gap-4 justify-content-between">
            <div class="card text-bg-primary mb-3" style="width: 25rem;">
                <div class="card-body">
                    ...
                    <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi, nemo. Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet.</p>
                    <router-link to="/admin/books" active-class="active" class="btn btn-outline-light">See details</router-link>
                </div>
            </div>
            <div class="card text-bg-success mb-3" style="width: 25rem;"> 
                <div class="card-body">
                    ...
                    <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat voluptate cupiditate est illum blanditiis accusantium quam quo iure a fugiat.</p>
                    <router-link to="/admin/users" active-class="active" class="btn btn-outline-light">See details</router-link>
                </div>
            </div>
            <div class="card text-bg-danger mb-3" style="width: 25rem;">
                <div class="card-body">
                    ...
                    <p class="card-text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Perspiciatis cupiditate a aliquam, officia numquam minus.</p>
                    <router-link to="/admin/users" active-class="active" class="btn btn-outline-light">See details</router-link>
                </div>
            </div>
        </div>
